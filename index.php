...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="margin-bottom:0px;">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample05">
      ...
      <button type="button" class="btn btn-outline-light" id="profBtn" style="margin-right:5px" onclick="window.location='profileDoc.php'" <?php if(!$doclog){echo "hidden";}?>> My Profile </button>
      <button type="button" class="btn btn-outline-light" id="profBtn" style="margin-right:5px" onclick="window.location='profilePat.php'" <?php if(!$patlog){echo "hidden";}?>> My Profile </button>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h1>HealthConnect</h1>
          <p>Helping people of all ages.</p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h1>HealthConnect</h1>
          <p>Improving communication between patients and doctors.</p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h1>HealthConnect</h1>
          <p>Providing extensive medical information online.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container marketing">
        ...
        <div style="text-align:center">
          <h1 id="webtitle">HealthConnect</h1>
          <p style="font-size:14pt">HealthConnect is an application which allows patients and doctors to easily access medical records and interact with one another.</p>
        </div><!-- /.row -->
