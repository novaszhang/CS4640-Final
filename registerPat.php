...
<body>
  ...
  <form class="form-register" onsubmit="return validateForm()" method="post">
    <h2 class="regText">Register as Patient</h2>
    <p class="regText">All fields are required.</p>
...
<script src="Scripts/validateRegPat.js"></script>
<!-- jQuery library -->
...
<?php
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($result->numrows == 0){
      $addquery = "insert into patients values ('".$_POST["firstname"]."', '".$_POST["lastname"]."','".
        $email."','".md5($_POST["pw"])."','".$_POST["birthday"]."','".$_POST["phone"]."','".$_POST["sex"]."', NULL, NULL)";
